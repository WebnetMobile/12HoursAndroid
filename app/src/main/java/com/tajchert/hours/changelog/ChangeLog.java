 ...
 */
package com.tajchert.hours.changelog;
...
public class ChangeLog {
    ...
    /**
     * Create a {@code ChangeLog} instance using the default {@link android.content.SharedPreferences} file.
     *
     * @param context
     *         Context that is used to access the resources and to create the ChangeLog dialogs.
     */
    ...
    protected AlertDialog getDialog(boolean full) {
        ...
        builder.setTitle(
                mContext.getResources().getString(R.string.changelog_title))
                .setView(wv)
                .setCancelable(false)
                // OK button
                .setPositiveButton(
     ...
     *         versions newer than the last version are returned.
     *
     * @return A sorted {@code List} containing {@link com.tajchert.hours.changelog.ChangeLog.ReleaseItem}s representing the (partial)
     *         change log.
     *
     ...
     *         versions newer than the last version are returned.
     *
     * @return A {@code SparseArray} containing {@link com.tajchert.hours.changelog.ChangeLog.ReleaseItem}s representing the (partial)
     *         change log.
     */
     ...
     * @param changelog
     *         The {@code SparseArray} to add a new {@link com.tajchert.hours.changelog.ChangeLog.ReleaseItem} instance to.
     *
     ...
     *         {@link #readChangeLog(org.xmlpull.v1.XmlPullParser, boolean)} will stop reading more elements from
     *         the change log file.
     *
    ...
    /**
     * Returns a {@link java.util.Comparator} that specifies the sort order of the {@link com.tajchert.hours.changelog.ChangeLog.ReleaseItem}s.
     *
     * <p>
